...
- **README** — pointer line "For the Accrue-facing integration surface, see [Accrue Seam Contract](guides/accrue-seam.md)" was added but **(RETRO 2026-04-29: this addition plus the `:ex_doc` dependency and `docs:` config block in `mix.exs`/`mix.lock` were in the working tree at SUMMARY time and never committed during Phase 7-02; they landed retroactively in commit `813438d` during v1.1 milestone close.)** The original SUMMARY claim "left untouched" was incorrect.
