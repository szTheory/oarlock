...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 28-01-01 | 01 | 1 | PROOF-04 | T-28-01 | `Paddle.MockServer` does not make fresh consumers require optional HTTP deps unless they use MockServer | compile/unit | `mix compile --warnings-as-errors`; package smoke fresh consumer without `plug`; `MIX_ENV=test mix test test/paddle/mock_server_test.exs` | partial | pending |
