...
| **Full suite command** | `node $HOME/.codex/gsd-core/bin/gsd-tools.cjs query init.phase-op 29 && rg -n "B-0[123567]" .planning/BACKLOG.md .planning/BACKLOG-ARCHIVE.md && rg -n "subscription-create|Reopen Condition|resolved" .planning/threads` |
