...
- [x] **CAT-01**: User can list products with auto-pagination (`Paddle.Products.list/2`, `Paddle.Products.stream/2`, `Paddle.Products.all/2`).
- [x] **CAT-02**: User can fetch a single product by ID (`Paddle.Products.get/2`).
- [x] **CAT-03**: User can list prices with auto-pagination (`Paddle.Prices.list/2`, `Paddle.Prices.stream/2`, `Paddle.Prices.all/2`).
- [x] **CAT-04**: User can fetch a single price by ID (`Paddle.Prices.get/2`).
- [x] **CAT-05**: User is warned in documentation about attempting to fetch "Custom" prices/products via the Catalog.
...
- [x] **NOTIF-01**: User can list notification settings (`Paddle.NotificationSettings.list/2`, `stream/2`, `all/2`).
- [x] **NOTIF-02**: User can fetch a single notification setting by ID (`Paddle.NotificationSettings.get/2`).
